/**
 * Outline icon set (Lucide-style) for page chrome, section headings, and actions.
 * Use data-icon="name" + enhanceIcons(), or createIcon() / setButtonIcon() in JS.
 */

/** @type {Record<string, string>} SVG path(s) for a 24×24 viewBox */
const PATHS = {
  bus: '<path d="M8 6v6"/><path d="M16 6v6"/><path d="M2 12h20"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><path d="M8 18a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M16 18a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M6 6h12v4H6z"/>',
  route:
  ...
  'file-signature':
    '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M8 12h.01"/><path d="M10 20v-4a2 2 0 1 1 4 0v4"/><path d="M8 16h2"/><path d="M14 16h2"/>',
  calendar:
    '<path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/>',
  'calendar-plus':
    '<path d="M8 2v4"/><path d="M16 2v4"/><path d="M21 14V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8"/><path d="M3 10h18"/><path d="M16 19h6"/><path d="M19 16v6"/>',
  'calendar-range':
  ...
  'pen-line': '<path d="M12 20h9"/><path d="M16.376 3.622a1 1 0 0 1 3.002 3.002L7.368 18.635a2 2 0 0 1-.855.506l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.854z"/>',
  scale:
...
/**
 * @param {string} name
 * @param {{ className?: string, decorative?: boolean, title?: string }} [opts]
 * @returns {SVGSVGElement}
 */
export function createIcon(name, opts = {}) {
  const { className = 'icon', decorative = true, title } = opts;
...
/**
 * Prepend an icon to an element (idempotent).
 * @param {HTMLElement} el
 * @param {string} name
 */
export function prependIcon(el, name) {
  if (el.querySelector(':scope > .icon')) return;
  el.prepend(createIcon(name));
  el.classList.add('with-icon');
}

/**
 * Replace element contents with icon + text (for buttons / simple labels).
 * @param {HTMLElement} el
 * @param {string} name
 * @param {string} text
 */
export function setLabeledIcon(el, name, text) {
  el.replaceChildren(createIcon(name), document.createTextNode(text));
  el.classList.add('with-icon');
}

/**
 * Scan [data-icon] hosts and prepend icons.
